 ...
 * }
 */
function makePersonObject(my_id, my_name, my_email) {
  var person = Object();
  person.id = my_id;
  person.name = my_name;
  person.email = my_email;
  return person;
}
...
function makeSmartPerson(my_name) {
  var smartPerson = Object();
  smartPerson.name = my_name;
  smartPerson.sum = function(a, b) {
    return a + b;
  };
